...
description: "The two participant roles on BASE and how their responsibilities differ."
---

BASE has two participant roles: [miners](/concepts/glossary#miner) produce work, and [validators](/concepts/glossary#validator) publish the final scores on-chain. This page explains what each one does.
