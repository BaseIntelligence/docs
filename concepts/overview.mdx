---
title: "What is BASE?"
description: "A plain-language introduction to BASE: a multi-challenge Bittensor subnet running on netuid 100."
---
...
BASE runs on **netuid 100**. The [netuid](/concepts/glossary#netuid) is the subnet's id on the Bittensor chain. This value is fixed in the canonical configuration.
