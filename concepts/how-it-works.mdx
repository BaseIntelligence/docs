...
This page traces one unit of work through BaseIntelligence end to end. Read [What is BaseIntelligence?](/concepts/overview) first if you have not built a mental model yet.
...
BaseIntelligence runs as a single Docker Swarm with two kinds of nodes:
