...
This guide covers local validation and production-oriented configuration for running PRISM as a BaseIntelligence challenge.
...
_Source: `docs/operators.md:34-50` (evaluator image literal omitted; it references a non-BaseIntelligence registry — supply your own)._
