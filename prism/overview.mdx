...
PRISM is a BASE challenge for **decentralized neural architecture search (NAS)**. [Miners](/concepts/glossary#miner) submit a model architecture and a training recipe, and the challenge competes them on a single, cheat-resistant question: **how fast does a model learn from scratch?**
