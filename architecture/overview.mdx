...
description: "How the BASE subnet is assembled: a single Docker Swarm master node, manually enrolled worker nodes, and the epoch weight flow that ends on-chain."
icon: "sitemap"
---

BASE is a **multi-challenge Bittensor subnet** (netuid `100`). Independent
