---
title: "Challenges on BaseIntelligence"
description: "The challenges that run on the BaseIntelligence subnet, and how each one rewards miners."
---

BaseIntelligence is a multi-challenge Bittensor subnet (netuid 100). Each challenge is an independent repository and Docker image that owns its own logic, public routes, submissions, scoring data, and database schema. The subnet routes miner traffic to the right challenge, collects each challenge's raw scores, and normalizes them into subnet weights.
