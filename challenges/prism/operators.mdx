---
title: "PRISM challenge operators"
description: "Challenge-operator guide for PRISM (not BASE subnet validator mint): local validation, runtime config, data plane, compute budget, LLM gate."
icon: "server"
---
