...
See [Scoring](/challenges/prism/scoring) for the math and [How PRISM works](/challenges/prism/how-it-works) for the full pipeline.
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/challenges/prism/quickstart">
    Build and submit your first two-script bundle.
  </Card>
  <Card title="How PRISM works" icon="gears" href="/challenges/prism/how-it-works">
