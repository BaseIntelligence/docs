# SOURCES — BaseIntelligence Docs Source Manifest

> Generated by Foundation Task T1. This manifest pins every source repository used
> to author the BaseIntelligence Mintlify documentation. All clones are FRESH from
...
- **Contents:** The Mintlify documentation site for BaseIntelligence (currently the Mintlify Starter Kit template — `docs.json`, `index.mdx`, `quickstart.mdx`, `logo/`, `favicon.svg`). This is the deliverable repo all docs work targets.
